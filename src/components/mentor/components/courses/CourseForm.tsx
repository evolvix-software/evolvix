...
import { X, Save, Plus, Trash2, Upload, FileText, Video, FileQuestion, Clock, Calendar, ChevronLeft, ChevronRight, CheckCircle2, BookOpen, FolderTree, Settings as SettingsIcon, Eye } from 'lucide-react';
import { Course, Instructor, Module, CourseSchedule, Lesson, VideoTimestamp, LessonAssignment, LessonTest, CourseProject } from '@/data/mock/coursesData';
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newModules: Module[] = modules.map(m => ({
      ...
      lessons: m.lessons.map(l => ({
        ...
        assignment: courseType === 'recorded' ? (l.assignment || undefined) : undefined,
                                      ...
                                      <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                                        <div className="flex items-center justify-between mb-2">
                                          ...
                                          <Button
                                            ...
                                            className="text-xs"
                                          >
                                            {lesson.assignment ? 'Edit' : 'Add'} Assignment
                                          </Button>
                                        </div>
                                        {lesson.assignment && (
                                          <div className="space-y-2 mt-2">
                                            ...
                                            <textarea
                                              ...
                                              className="w-full px-2 py-1 text-xs border border-slate-300 dark:border-slate-700 rounded bg-white dark:bg-slate-800 text-slate-900 dark:text-white resize-none"
                                            />
                                            <Input
                                              type="number"
