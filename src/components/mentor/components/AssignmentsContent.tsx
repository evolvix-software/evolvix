...
import { UploadAssignment, StudentSubmissions, GradeAssignment } from './assignments';
import { Assignment, AssignmentSubmission } from './assignments/types';
import { mockAssignments, mockSubmissions } from './assignments/mockData';
