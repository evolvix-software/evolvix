              ...
              <div className="border-t border-slate-200 dark:border-slate-700 p-4 bg-white dark:bg-slate-800">
                <div className="flex space-x-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border-2 border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                  />
                  <Button 
                    onClick={() => {
                      if (chatInput.trim()) {
          ...
          {activeTab === 'waiting' && (
            <div className="flex-1 overflow-y-auto p-6 bg-white dark:bg-slate-800">
              <div className="mb-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-800">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-yellow-700 dark:text-yellow-300 font-medium">Waiting Room</p>
              ...
              <div className="space-y-3">
                {waitingParticipants.length === 0 ? (
                  ...
                  waitingParticipants.map((participant) => (
                    <div
                      key={participant.id}
                      className="p-4 rounded-xl border-2 border-yellow-200 dark:border-yellow-800 bg-yellow-50 dark:bg-yellow-900/20 flex items-center justify-between transition-all"
                    >
                      <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300">
          ...
          {activeTab === 'attendance' && (
            <div className="flex-1 overflow-y-auto p-6 bg-white dark:bg-slate-800">
              <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-blue-700 dark:text-blue-300 font-medium">Total Attendance</p>
